...
typedef enum
{
    ...
    scxrInputEventType_Gamepad,
    scxrInputEventType_Generic,
} scxrTouchEventType; // TODO naming issue
...
typedef enum
{
    scxrGamepadButtonType_A,
    scxrGamepadButtonType_B,
    scxrGamepadButtonType_X,
    scxrGamepadButtonType_Y,
    scxrGamepadButtonType_BACK,
    scxrGamepadButtonType_GAMEPAD_GUIDE,
    scxrGamepadButtonType_START,
    scxrGamepadButtonType_LEFT_THUMB,
    scxrGamepadButtonType_RIGHT_THUMB,
    scxrGamepadButtonType_LEFT_SHOULDER,
    scxrGamepadButtonType_RIGHT_SHOULDER,
    scxrGamepadButtonType_DPAD_UP,
    scxrGamepadButtonType_DPAD_DOWN,
    scxrGamepadButtonType_DPAD_LEFT,
    scxrGamepadButtonType_DPAD_RIGHT,
}scxrGamepadButtonType;

typedef struct scxrGamepadEvent
{
    scxrKeyEventType type;
    scxrGamepadButtonType button;
    short valueX;
    short valueY;
} scxrGamepadEvent;
