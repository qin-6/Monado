...
#define scxrFrameMask_Left		0x01 			///< Maps to index/stream 0 for stereo modes
#define scxrFrameMask_Right		0x02			///< Maps to index/stream 1 for stereo modes
#define scxrFrameMask_Special 	0x80000000  	///< Special-case masks that aren't direct indices are noted by setting this bit.
#define scxrFrameMask_All  		0xFFFFFFFF  	///< Requests the system map to all available frames

#define QUEST_RESOLUTION_WIDTH 	 		1440
#define QUEST_RESOLUTION_HEIGHT  		1660
#define QUEST2_RESOLUTION_WIDTH 		1832
#define QUEST2_RESOLUTION_HEIGHT 	 	1920
#define PICO_NEO3_RESOLUTION_WIDTH 		1832
#define PICO_NEO3_RESOLUTION_HEIGHT 	1920
#define NREAL_RESOLUTION_WIDTH 			1080
#define NREAL_RESOLUTION_HEIGHT 		1920

#define SCXR_AUDIO_CHANNEL_COUNT 	2             ///< Audio is currently always stereo
#define SCXR_AUDIO_SAMPLE_SIZE 	 	sizeof(int16_t) ///< Audio is currently singed 16-bit samples (little-endian)
#define SCXR_AUDIO_SAMPLING_RATE    48000         ///< Audio is currently always 48khz
#define SCXR_AUDIO_FRAME_LENGTH_MS	5           ///< Sent audio has a 5 ms default frame length.  Received audio has 5 or 10 ms frame length, depending on the configuration.
#define SCXR_AUDIO_BYTES_PER_MS 	SCXR_AUDIO_CHANNEL_COUNT * SCXR_AUDIO_SAMPLE_SIZE * SCXR_AUDIO_SAMPLING_RATE / 1000 ///< Total bytes of audio per ms

#define SCXR_NUM_CONTROLLERS  2
...
typedef enum
{
    scxrDeviceType_UnKnown = 0,
    scxrDeviceType_Quest,
    scxrDeviceType_Quest2,
    scxrDeviceType_Pico_Neo3,
    scxrDeviceType_Pico4,
    scxrDeviceType_Nreal
}scxrDeviceType;

typedef enum
{
    scxrDevicePlatformType_Android = 0,
    scxrDevicePlatformType_Ios = 1
} scxrDevicePlatformType;

typedef enum
{
	scxrBitrateControlMode_Adaptive = 0,
	scxrBitrateControlMode_Fixed = 1
}scxrBitrateControlMode;
...
typedef struct scxrXRTrackingState
{
    ...
    scxrControllerTrackingState controller[2];
